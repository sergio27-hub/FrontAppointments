...
const CarouselComponent = () => {
  ...
  return (
    <div
      ...
      className="bg-black dark:bg-black dark:bg-opacity-50 overflow-hidden h-[900px] relative w-full flex flex-col items-center justify-center"
      ...
      <div className="absolute w-full overflow-hidden bottom-8 after:clear-both after:block after:content-['']">
        <div
          ...
          <img
            ...
            className="block w-full h-[900px]"
            alt="Motorbike Smoke" />
        ...
        <div
          ...
          <img
            ...
            alt="Mountaintop" />
          <div className="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-black md:block">
            <h5 className="text-5xl text-white">Quality and experience</h5>
            <p className='text-3xl text-white font-mono'>reflects our dedication to providing superior service and expertise. We ensure top-notch results and customer satisfaction in every project.</p>
          </div>
        </div>
        <div
          className="relative float-left -mr-[100%] hidden w-full !transform-none opacity-0 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
          ...
          <div className="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-black md:block">
            <h5 className="text-5xl text-white font-bold">PROJECT COMPLETED !</h5>
            <p className='text-white text-3xl'>Potencial Project</p>
          </div>
        </div>
      </div>
